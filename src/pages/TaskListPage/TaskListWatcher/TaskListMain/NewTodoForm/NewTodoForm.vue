...
<template>
  <div class="flex gap-2">
    <input
      ...
      class="flex-1 rounded-md border border-neutral-300 px-3 py-2 select-none focus:border-transparent focus:ring-2 focus:ring-neutral-500 focus:outline-none"
